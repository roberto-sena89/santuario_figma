...
/**
 * Escala de Voluntários — página interna da equipe (#/escala-voluntarios).
 * Fora do menu e do rodapé por decisão: o visitante usa #/cultos
 * (horários + endereço). A equipe acessa pela URL direta.
 */
export default function EscalaVoluntarios() {
      ...
      <SectionHero image="/fotos/agenda/1.jpg" label="Agenda semanal">
        <div className="mb-0 max-w-2xl text-left">
            ...
            <p className="mt-6 inline-flex items-start gap-3 rounded-2xl border border-white/15 bg-white/10 backdrop-blur-sm px-4 py-3 text-sm sm:text-base text-white/90 max-w-xl leading-relaxed">
              <span>Escala de serviço das equipes — consulte teu dia e horário.</span>
            </p>
        </div>
      </SectionHero>
