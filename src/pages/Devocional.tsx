...
import { getDevotionalByDate, getAllDevotionals } from "../data/devotionals";
    ...
    <main id="main-content" className="min-h-screen bg-background pt-16">
            ...
            <aside className="space-y-6">
              ...
              <div className="rounded-2xl border border-border/60 bg-card/50 p-5">
                ...
                <div className="flex flex-wrap gap-2">
                  <a href={whatsappHref} target="_blank" rel="noopener noreferrer" className="inline-flex items-center gap-2 rounded-full bg-[#25D366] px-4 py-2 text-xs font-semibold text-white hover:bg-[#1ebd5a] transition-colors">
                    WhatsApp
                  </a>
      ...
      <section className="py-10 bg-muted/30 border-t border-border/40">
        <div className="max-w-3xl mx-auto px-4 text-center">
          ...
          <p className="text-xs text-muted-foreground/70 mt-3">Baseado em devocionaldiario.com.br — adaptado ao design Santuário da Adoração.</p>
        </div>
      </section>
    </main>
  );
