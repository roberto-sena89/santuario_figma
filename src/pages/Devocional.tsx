            ...
            <aside className="space-y-6">
              ...
              <div className="rounded-2xl border border-border/60 bg-card/50 p-5">
                ...
                <div className="flex flex-wrap gap-2">
                  <a href={whatsappHref} target="_blank" rel="noopener noreferrer" className="inline-flex h-11 items-center justify-center gap-2 rounded-full bg-[#25D366] px-5 text-sm font-semibold text-white shadow-md hover:bg-[#1ebd5a] hover:-translate-y-0.5 transition-all">
