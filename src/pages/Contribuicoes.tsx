      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        {/* Header */}
                ...
                <div className="text-center max-w-3xl mx-auto my-10">
                                  <div className="bg-gold/8 border border-gold/20 rounded-2xl p-6 sm:p-8 shadow-sm">
                                    <blockquote className="font-bible italic text-foreground/80 text-xl leading-relaxed">
                                      ...
                                      <cite className="not-italic text-gold-deep dark:text-gold-light text-sm font-medium mt-3 block">— 2 Coríntios 9:7</cite>
                                    </blockquote>
                                  </div>
                                </div>
        ...
        <div className="grid sm:grid-cols-2 gap-8">
          ...
          <div className="bg-card/80 backdrop-blur-sm border border-border rounded-2xl overflow-hidden shadow-sm">
            <div className="bg-gradient-to-r from-gold/15 via-transparent to-transparent border-b border-border/60 p-6">
              <div className="flex items-center gap-3">
                <div className="grid h-11 w-11 place-items-center rounded-xl bg-gold/15 ring-1 ring-gold/25 shadow-sm shadow-gold/20">
                  <svg className="w-5 h-5 text-gold-deep dark:text-gold-light" fill="none" viewBox="0 0 24 24" stroke="currentColor" aria-hidden="true">
            ...
            <div className="p-6 border-b border-border/60">
              <div
                className="w-40 h-40 mx-auto bg-muted/50 rounded-2xl flex flex-col items-center justify-center gap-2 border-2 border-dashed border-gold/40 transition-colors duration-200 hover:border-gold/70"
                aria-label="Espaço para QR Code PIX"
              >
                <svg className="w-10 h-10 text-gold-deep/50 dark:text-gold-light/50" fill="none" viewBox="0 0 24 24" stroke="currentColor" aria-hidden="true">
            ...
            <div className="p-6 space-y-3">
              {pixData.map((item) => (
                <div key={item.label} className="flex items-center justify-between gap-4 rounded-xl px-3 py-2 transition-colors duration-150 hover:bg-muted/40">
                  ...
                  <button
                    ...
                    className="flex-shrink-0 w-7 h-7 flex items-center justify-center rounded-lg text-muted-foreground hover:text-gold-deep hover:bg-gold/10 dark:hover:text-gold-light transition-colors"
              ...
              <button
                ...
                className="w-full mt-4 bg-gold hover:bg-gold-hover text-gray-900 font-semibold py-3 rounded-xl text-sm transition-all duration-300 hover:-translate-y-0.5 hover:shadow-lg hover:shadow-gold/30"
              >
                    ...
                    <div className="space-y-5">
                        ...
                        <div className="space-y-2.5">
                          {[
                            ...
                            <div key={i} className="flex items-start gap-2.5">
                              <svg className="w-4 h-4 text-gold-deep dark:text-gold-light flex-shrink-0 mt-0.5" fill="currentColor" viewBox="0 0 20 20" aria-hidden="true">
                      ...
                      <div className="bg-gold/8 border border-gold/25 rounded-2xl p-6 transition-all duration-300 hover:shadow-lg hover:shadow-gold/10">
                        ...
                        <a
                          ...
                          className="inline-flex items-center gap-2 text-gold-deep dark:text-gold-light hover:text-gold text-sm font-medium transition-colors"
                        >
