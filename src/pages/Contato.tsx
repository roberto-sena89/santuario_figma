    ...
    <main id="main-content" className="min-h-screen bg-background pt-16">
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <PageTitle
                  ...
                  eyebrowIcon="💬"
                  title="Contato"
                  subtitle="Tem perguntas, pedidos de oracao ou quer saber mais sobre nossa igreja? Estamos aqui para ajudar."
                  subtitleIcon="✉️"
                  align="left"
                />
          ...
          <aside className="space-y-5">
            ...
            {/* WhatsApp */}
                        ...
                        >
                          ...
                          <div>
                            <p className="font-semibold text-sm text-foreground">Falar pelo WhatsApp</p>
                            <p className="text-muted-foreground/80 text-xs">Resposta rápida em horário comercial</p>
                          </div>
                        </a>
