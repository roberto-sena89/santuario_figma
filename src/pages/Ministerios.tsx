      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="mb-12 max-w-2xl">
          ...
          <p className="text-muted-foreground text-base leading-relaxed">
            Cada ministério é um braço do corpo de Cristo em ação. Conheça como você pode contribuir e encontrar seu lugar na nossa família.
          </p>
        </div>
          ...
          {MINISTERIOS.map((m) => (
            <article key={m.id}>
              <button
                ...
                className={`w-full text-left bg-card border rounded-2xl p-6 transition-all hover:shadow-md ${
                  selected?.id === m.id
              ...
              >
                ...
                <div className="mt-4 flex items-center gap-2 text-sm font-medium" style={{ color: m.color }}>
                  {selected?.id === m.id ? "Ver menos" : "Saiba mais"}
                  <svg
                    className={`w-4 h-4 transition-transform ${selected?.id === m.id ? "rotate-180" : ""}`}
                    fill="none"
                    viewBox="0 0 24 24"
                    stroke="currentColor"
                    aria-hidden="true"
            ...
            <div className="p-6 sm:p-8 grid sm:grid-cols-2 gap-8">
              ...
              <div className="space-y-4">
                <div className="flex items-start gap-3">
                  <svg className="w-4 h-4 text-accent mt-0.5 flex-shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor" aria-hidden="true">
