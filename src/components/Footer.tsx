    ...
    <footer className="bg-primary text-primary-foreground" role="contentinfo">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12">
          ...
          <div className="lg:col-span-1">
            <div className="flex items-center gap-3 mb-4">
              ...
              <div>
                ...
                <div className="text-primary-foreground/60 text-xs leading-tight">
                  {CHURCH.slogan}
                </div>
              </div>
            </div>
            ...
            <div className="flex gap-3">
              <a
                ...
                className="w-9 h-9 rounded-full border border-primary-foreground/20 flex items-center justify-center text-primary-foreground/60 hover:text-primary-foreground hover:border-primary-foreground/50 transition-colors"
          ...
          {/* Navigation */}
          <div>
            <h3 className="font-display font-semibold text-sm uppercase tracking-widest text-primary-foreground/50 mb-5">
              Navegação
            </h3>
          ...
          <div>
            ...
            <address className="not-italic space-y-3">
              <div className="flex items-start gap-3">
                <svg className="w-4 h-4 mt-0.5 text-accent flex-shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor" aria-hidden="true">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M17.657 16.657L13.414 20.9a1.998 1.998 0 01-2.827 0l-4.244-4.243a8 8 0 1111.314 0z" />
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M15 11a3 3 0 11-6 0 3 3 0 016 0z" />
                </svg>
                <span className="text-primary-foreground/70 text-sm leading-snug">
                  {CHURCH.address.full}
                </span>
              </div>
            ...
            <div className="mt-6 pt-6 border-t border-primary-foreground/10">
              <p className="text-primary-foreground/50 text-xs leading-relaxed">
                Domingos: 09h, 10h30 e 19h<br />
                Quartas: 19h30 — Estudo Bíblico<br />
                Sextas: 19h30 — Jovens
              </p>
            </div>
          </div>
        ...
        <div className="mt-12 pt-8 border-t border-primary-foreground/10 flex flex-col sm:flex-row items-center justify-between gap-4">
          <p className="text-primary-foreground/40 text-xs">
            © {year} {CHURCH.name}. Todos os direitos reservados.
          </p>
